...
| Rides & Midway | Ferris wheel / big rides | ❌ | Category is saturated (9 squares across P18, P23, P27, P29, P34, P36, P51, SD1). Stuck-at-the-top rejected earlier, and the ride-operator one-yank-safety-check draft was pulled as weaker than its siblings. Closed. |
| Rides & Midway | Skyride gondola | ✅ | Regular Skyride nerves banked (P34). The Skyglider underwear-throw landed as the Special Dares essential (SD1). |
| Rides & Midway | Arcade / coin-pusher games | ✅ | Coin-pusher win banked (P36). |
| Rides & Midway | Space Tower | ❌ | The view joke was already rejected once and nothing else landed. Category saturated. Closed. |
| Rides & Midway | Ye Old Mill | ✅ | Two people exiting in complete silence banked (P51). Rewritten in the scissors pass, replacing 'damp and disappointed', which stacked a hedge onto an inner-state read. Silence is objective *and* says more about the ride than disappointment did. A 'wet ass' version was drafted and passed over as probably not true to the ride. |
...
| Landmarks & margins | Bandshell / free-stage acts | ✅ | Live-polka-confirmed-by-accordion banked (P62). Dino's Gyros books cover bands, a live-music-at-a-food-stand avenue still open. |
| Landmarks & margins | Political party booths & candidates | ✅ | GOP-building photo-op kiss (P55) and the dead-empty Libertarian booth (P56) banked. |
...
A review of the banked pool for its *weakest* squares, run before merging the completion pass. Twelve candidates were nominated and adjudicated one by one. The result was 2 cuts, 6 rewrites, 1 new square, and 5 explicit keeps.

**The five keeps matter as much as the cuts.** Each was nominated and defended, so do not re-pitch cutting them.

| Square | Nominated because | Kept because |
|---|---|---|
| P28, hog over 270 lbs | 'I was certain' is a guess with no scale in sight | The weight is properly researched and the claim is honestly made. Totally claimable. |
| P36, coin-pusher tickets | Outcome is not in the player's control and there is no joke | **The odds are the joke.** Coin pushers pay out almost never, so actually walking away with tickets is itself the remarkable event. |
| P30, new-foods list | Procedural homework, and the payoff is hedged away | The homework is the point. It rewards being a *proper* fairgoer, and the annual new-foods list is a real fair institution. |
...
- **Surveillance masquerading as observation.** If marking a square means following one stranger across several minutes or several trips (the 4th milk refill, the five-minute cotton candy watch, a whole offer-and-renege exchange), it is not a sighting. Look for the *artifact* the event leaves behind and mark that instead.
- **Inner-state reads that survived earlier review.** 'Realize in real time', 'looking really annoyed', 'damp and disappointed'. The style guide already bans these, and three still shipped, so audit for them specifically rather than trusting the ban.
- **Vague comparators.** 'The size of a pillow' fails because pillows vary. 'Bigger than their own head' works because heads do not, and it self-calibrates to whoever is carrying the thing.
...
| Overheard Pronto Pup vs corn dog opinion | Rejected | Superseded by P20, which lands the same joke as a controllable do-it. |
...
| Mobility scooter cut-off | Rejected | Reworked into the mid-street dead-stop pileup (P32). |
...
| Deep-fried Oreo | Rejected | Already have the deep-fried candy bar (P26); no second deep-fried needed unless it's special. |
...
| Cumbersome-purchase haulers (cast iron, mop + broom) | Rejected | Never-seen / didn't land as sightings. The expensive-thing angle became the hot tub (P49). |
...
| Tractor price tag | Rejected | Already have a tractor square (P22). |
...
| Mobility scooters (all angles) | Rejected | Whole avenue killed. All rentals, and the cut-off version was already reworked into P32. |
...
| Foot-long hot dog | Rejected | Too generic (everyone has one). Became walleye on a stick (P57), which is fair-specific. |
| Live radio broadcast sighting | Rejected | Boring avenue. |
| Cash-only booth / ATM-fee pain | Rejected | Boring avenue. The porta-potty side of that row became the toilet square (P54). |
